...
!(function (t, e) {
  ...
  class Ti {
    ...
    getWidth() {
      ...
      return Math.abs(window.inner-containerWidth - t);
    }
    hide() {
    ...
    _setElementAttributes(t, e, i) {
      ...
      this._applyManipulationCallback(t, t => {
        if (t !== this._element && window.inner-containerWidth > t.clientWidth + n)
          return;
  ...
  class Ui extends $ {
    ...
    toHtml() {
      const t = document.createElement('div');
      t.inner-containerHTML = this._maybeSanitize(this._config.template);
      ...
      n &&
        ((e = this._resolvePossibleFunction(e))
          ? o(e)
            ...
            : this._config.html
            ? (n.inner-containerHTML = this._maybeSanitize(e))
            : (n.textContent = e)
          : n.remove());
    }
    _maybeSanitize(t) {
      return this._config.sanitize
        ? (function (t, e, i) {
            ...
            return n.body.inner-containerHTML;
    ...
    _putElementInTemplate(t, e) {
      if (this._config.html) return (e.inner-containerHTML = ''), void e.append(t);
  ...
  const Gi = new Set(['sanitize', 'allowList', 'sanitizeFn']),
    ...
    rn = {
      ...
      selector: !1,
      template:
        '<div class="tooltip" role="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner-container"></div></div>',
      title: '',
      trigger: 'hover focus',
    },
    an = {
  ...
  class ln extends W {
    ...
    _getContentForTemplate() {
      return { '.tooltip-inner-container': this._getTitle() };
    }
    _getTitle() {
      return (
  ...
  class xn extends W {
    ...
    _setInitialAttributesOnChild(t) {
      t = this._getinner-containerElement(t);
